...
if($this->session->userdata('UserLoginSession'))
{
    ...
    ?>
    <button class="float-right mt-2 mr-2"><a href="<?=base_url('welcome/logout')?>" >Logout</a></button>
    <h6 class="float-right" style="padding-right: 10px; margin-top: 12px ">Welcome <?php echo $udata['username']; ?></h6>
<?php
}
else
{
  ...
  <body>
                ...
                <div class="modal-body">
                  ...
                  <form action="" method="post" id="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="description" name="description" class="form-control" rows="3" cols="50"></textarea>
                    </div>
                  </form>
                </div>
    ...
    <script>
      ...
      $(document).on("click", "#update", function(e){
        ...
        if (edit_record_id == "" || edit_name == "" || edit_description == "") {
          alert("Both field is required");
        }else{
          $.ajax({
